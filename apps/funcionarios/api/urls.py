...
urlpatterns = [
    ...
    path(
        f"{_BASE_ESCOLAS}/<str:codigoUE>/funcionarios/",
    ...
    path(
        f"{_BASE_ESCOLAS}/<str:codigoUE>/funcionarios/"
        "funcoes-atividades/<int:codigoFuncaoAtividade>/",
    ...
    path(
        f"{_BASE_ESCOLAS}/<str:ueCodigo>/funcionarios/funcoes-atividades/",
    ...
    path(
        f"{_BASE_ESCOLAS}/<str:codigoUE>/funcionarios/"
        "funcoes-externas/<int:codigoFuncaoExterna>/",
    ...
    path(
        f"{_BASE_ESCOLAS}/<str:ueCodigo>/funcionarios/funcoes-externas/",
    ...
    path(
        f"{_BASE_FUNCIONARIOS}/cargo/<str:registroFuncional>/",
